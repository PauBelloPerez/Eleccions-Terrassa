...
const columnMapping = {
    '2024': {
        partitColumns: ['Junts','ERC', 'PACMA', 'PP', 'PSC', 'Comuns Sumar',  'VOX', 'Podemos','SALF', 'Altres'],
        totalVotesColumn: 'VOTS_CANDIDATURES',
        districteColumn: 'Districte',
        seccioColumn: 'Secció'
    },
    '2019': {
        partitColumns: ['Cs','ERC', 'Junts', 'Podemos', 'PP', 'PACMA', 'PSC', 'VOX', 'Altres'],
        totalVotesColumn: 'VOTS_CANDIDATURES',
        districteColumn: 'Districte',
        seccioColumn: 'Secció'
    },
